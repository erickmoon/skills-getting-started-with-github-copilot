...
activities = {
    ...
    "Soccer Team": {
        "description": "Join our competitive soccer team and participate in inter-school tournaments",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "sarah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Learn basketball fundamentals and play in friendly matches",
    ...
    "Drama Club": {
        "description": "Develop acting skills and participate in school theatrical productions",
